...
def profitCal(railway_class,ticket_price):
    # for first calss 25% profit and RS 100 for every ticket extra
    if railway_class == "first_class":
        # calculate ticket_price
