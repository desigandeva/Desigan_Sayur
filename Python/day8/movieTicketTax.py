...
def profitWithTax(movie_class,ticket_price):
    # ticketprice witn entertinement tax
    ticket_tax_price = ticket_price - ((ticket_price*5)/100)
    # check vip movie class
    if(movie_class=="vip"):
        # calculate ticket_price with 30% profit
        ticket_price = (ticket_price*30/100) + ticket_tax_price
    # check vip general class
    elif(movie_class=="general"):
        # calculate ticket_price with 20% profit
        ticket_price = (ticket_price*20/100) + ticket_tax_price
    # check vip matinee class
    elif(movie_class=="matinee"):
        # calculate ticket_price with 15% profit
