# **Problem Statement: Cricket Club Database**
# 
# You're tasked with designing a database for a local cricket club. The database should store information 
# about players, matches, and team statistics.
# 
# 1. **Players:**
