...
def findAliveFrogs(frog_list):
    ...
    alive_frog_list = [0]
    # check frog_list is sorted in desc order 
    if frog_list==sorted(frog_list,reverse=True):
        # return frog_list
        return frog_list
    # else
    else:
        ...
        # return call findAliveFrogs(alive_frog_list)
        return findAliveFrogs(alive_frog_list)
